...
describe('Developer Registration', () => {
  ...
  it('should load the form correctly', () => {
    ...
    expect(RegisterPage.telephoneInput.getAttribute('type')).toEqual('tel')
  ...
  it('should show success message after submit', () => {
    ...
    expect(RegisterPage.successMessage.getText()).toContain('Check you email to confirm your account')
  })
})
