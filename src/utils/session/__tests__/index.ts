...
import { mockLoginSession } from '../../cognito/__mocks__/cognito'
import {
  tokenExpired,
  deserializeIdToken,
  setSessionCookie,
...
import { LoginIdentity, LoginSession, RefreshParams } from '../../cognito/types'
...
describe('Session utils', () => {
  ...
  describe('removeSessionCookie', () => {
    ...
    it('should do nothing for an invalid host', () => {
      ...
      removeSessionCookie(inValidHost)
