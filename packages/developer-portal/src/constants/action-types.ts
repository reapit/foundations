...
const ActionTypes = {
  ...
  FETCH_APP_PIPELINE: 'FETCH_APP_PIPELINE',
  FETCH_APP_PIPELINE_SUCCESS: 'FETCH_APP_PIPELINE_SUCCESS',
  FETCH_APP_PIPELINE_FAILED: 'FETCH_APP_PIPELINE_FAILED',
  CLEAR_APP_PIPELINE: 'CLEAR_APP_PIPELINE',

  FETCH_APP_PIPELINE_RUNNERS: 'FETCH_APP_PIPELINE',
  FETCH_APP_PIPELINE_RUNNERS_SUCCESS: 'FETCH_APP_PIPELINE_SUCCESS',
  FETCH_APP_PIPELINE_RUNNERS_FAILED: 'FETCH_APP_PIPELINE_FAILED',
  CLEAR_APP_PIPELINE_RUNNERS: 'CLEAR_APP_PIPELINE',
  ...
  CREATE_APP_PIPELINE: 'CREATE_APP_PIPELINE',
  CREATE_APP_PIPELINE_SUCCESS: 'CREATE_APP_PIPELINE_SUCCESS',
  CREATE_APP_PIPELINE_FAILED: 'CREATE_APP_PIPELINE_FAILED',
  ...
  // Installations refactored
  FETCH_INSTALLATIONS_LIST: 'FETCH_INSTALLATIONS_LIST',
  FETCH_INSTALLATIONS_LIST_SUCCESS: 'FETCH_INSTALLATIONS_LIST_SUCCESS',
  FETCH_INSTALLATIONS_LIST_FAILED: 'FETCH_INSTALLATIONS_LIST_FAILED',

  FETCH_INSTALLATIONS_FILTER_LIST: 'FETCH_INSTALLATIONS_FILTER_LIST',
  FETCH_INSTALLATIONS_FILTER_LIST_SUCCESS: 'FETCH_INSTALLATIONS_FILTER_LIST_SUCCESS',
  FETCH_INSTALLATIONS_FILTER_LIST_FAILED: 'FETCH_INSTALLATIONS_FILTER_LIST_FAILED',

  SET_INSTALLATIONS_FORM_STATE: 'SET_INSTALLATIONS_FORM_STATE',
  CREATE_INSTALLATIONS: 'CREATE_INSTALLATIONS',
  REQUEST_INSTALLATIONS_TERMINATE: 'CREATE_INSTALLATIONS_TERMINATE',
  ...
  WEBHOOK_UPDATE_CREATE_EDIT_STATE: 'WEBHOOK_UPDATE_CREATE_EDIT_STATE',
  ...
  FETCH_WEBHOOK_LOGS: 'FETCH_WEBHOOK_LOGS',
  FETCH_WEBHOOK_LOGS_SUCCESS: 'FETCH_WEBHOOK_LOGS_SUCCESS',
  FETCH_WEBHOOK_LOGS_ERROR: 'FETCH_WEBHOOK_LOGS_ERROR',
  ...
  // Current member
  CURRENT_MEMBER_FETCH: 'CURRENT_MEMBER_FETCH',
  CURRENT_MEMBER_FETCH_SUCCESS: 'FETCH_CURRENT_MEMBER_SUCCESS',
  CURRENT_MEMBER_FETCH_FAILED: 'CURRENT_MEMBER_FETCH_FAILED',
  CURRENT_MEMBER_UPDATE: 'CURRENT_MEMBER_UPDATE',
  CURRENT_MEMBER_UPDATE_SUCCESS: 'CURRENT_MEMBER_UPDATE_SUCCESS',
  CURRENT_MEMBER_UPDATE_FAILED: 'CURRENT_MEMBER_UPDATE_FAILED',
}
