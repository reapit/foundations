...
//     } else {
//       yield put(fetchtAppAuthenticationFailed())
//       yield put(
//         errorThrownServer({
//           type: 'SERVER',
//           message: errorMessages.DEFAULT_SERVER_ERROR,
...
// export const fetchtAppAuthenticationListen = function*() {
//   yield takeLatest<Action<string>>(ActionTypes.REQUEST_AUTHENTICATION_CODE, requestAuthCode)
// }

// const appDetailSagas = function*() {
//   yield all([fork(appDetailDataListen), fork(fetchtAppAuthenticationListen)])
// }
