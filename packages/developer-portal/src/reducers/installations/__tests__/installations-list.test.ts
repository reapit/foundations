...
import installationsListReducer, { defaultState } from '../installations-list'
...
describe('installationsListReducer', () => {
  ...
  it('should set state to test when FETCH_INSTALLATIONS_LIST action is called with test', () => {
  ...
  it('should set state to test when FETCH_INSTALLATIONS_LIST_SUCCESS action is called with test', () => {
    const newState = installationsListReducer(undefined, {
  ...
  it('should set state to test when FETCH_INSTALLATIONS_LIST_FAILED action is called with test', () => {
    const newState = installationsListReducer(undefined, {
