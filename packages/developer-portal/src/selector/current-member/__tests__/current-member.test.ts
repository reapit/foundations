...
describe('selectCurrentMemberUpdateState', () => {
  it('should run correctly', () => {
    expect(selectCurrentMemberUpdateState(appState)).toEqual(appState.currentMember.update.state)
  })
})
