...
export interface ManageAppListingGraphicProps {
  isAnimated: boolean
}

export const docsAnimatedStyle = css`
  #manage-app-listing-one {
    animation: manage-app-listing-one__to 3000ms linear 1 normal forwards;
  }

  @keyframes manage-app-listing-one__to {
    0% {
      transform: translate(39.12742px, 25.990749px);
    }
    10% {
      transform: translate(52.64272px, 25.990749px);
    }
    100% {
      transform: translate(52.64272px, 25.990749px);
    }
  ...
  #manage-app-listing-two {
    animation: manage-app-listing-two__tr 3000ms linear 1 normal forwards;
  }

  @keyframes manage-app-listing-two__tr {
    0% {
      transform: translate(60.5px, 53.5px) rotate(0deg);
    }
    10% {
      transform: translate(60.5px, 53.5px) rotate(20.373115deg);
    }
    100% {
      transform: translate(60.5px, 53.5px) rotate(20.373115deg);
    }
  ...
  #manage-app-listing-three {
    animation: manage-app-listing-three__ts 3000ms linear 1 normal forwards;
  }

  @keyframes manage-app-listing-three__ts {
    0% {
      transform: scale(1, 1);
    }
    10% {
      transform: scale(1.2938, 1.293798);
    }
    100% {
      transform: scale(1.2938, 1.293798);
    }
...
export const ManageAppListingGraphic: FC<ManageAppListingGraphicProps> = ({ isAnimated }) => (
  <svg
    className={cx(isAnimated && docsAnimatedStyle, elMb10)}
    id="erekCw3TbW21"
  ...
  >
    ...
    <rect
      ...
      rx="1"
      ry="1"
      transform="translate(36.75 94.5)"
    ...
    <rect
      ...
      rx="1"
      ry="1"
      transform="translate(63 94.5)"
      fill="var(--info-graphic-accent-color-lightest)"
    />
    <g id="manage-app-listing-one" transform="translate(39.12742,25.990749)">
      <path
        d="M64.5593,22.0386c-.9453-5.879-6.2367-10.3914-12.613-10.3914-2.3987,0-4.7048.6384-6.706,1.829C42.2069,8.55954,36.7363,5.5,30.6533,5.5c-9.3971,0-17.0546,7.3539-17.0694,16.3926-.0001.056-.0002.1141.0018.1701-6.04098.9785-10.80557,6.0431-10.81556,12.1243C2.759,40.9666,8.62547,46.4815,15.6738,46.4815h46.8668c7.0484,0,12.9329-5.5149,12.9441-12.2945.0101-6.1331-4.8148-11.2298-10.9254-12.1484v0Z"
        transform="translate(-39.12742,-25.990749)"
        fill="var(--info-graphic-accent-color-lightest)"
      />
    </g>
    <path
      d="M121.209,133.349h-50.2457c-.001,0-.0019,0-.0029,0-4.2515-.012-7.6987-3.459-7.7103-7.711v-105.9911c.0116-4.2518,3.4591-7.6993,7.7109-7.7109h50.251c4.251.0116,7.699,3.4588,7.711,7.7103c0,.001,0,.0019,0,.0029v105.9888c0,.001,0,.001,0,.002-.015,4.253-3.459,7.697-7.711,7.709-.001,0-.002,0-.003,0Z"
      fill="var(--info-graphic-accent-color-lightest)"
      stroke="var(--info-graphic-accent-color-darkest)"
      strokeWidth="4"
    />
    <path
      d="M121.214,135.349h-50.2556c-5.3544-.013-9.6952-4.354-9.7083-9.708v-12.297c32.0121,0,41.1849,0,69.6729,0v12.3c-.017,5.354-4.354,9.692-9.709,9.705Z"
      fill="var(--info-graphic-accent-color-dark)"
    />
    <rect
      width="38.5"
      ...
      rx="19.25"
      ry="19.25"
      transform="translate(73.5001 26.25)"
    ...
    <rect
      ...
      rx="1"
      ry="1"
      transform="translate(73.7937 85.5774)"
      fill="var(--info-graphic-accent-color-lightest)"
    />
    <rect
      width="31.3533"
