...
describe('DNS Configuration', () => {
  it('Will show configuration page when dns info is returned', () => {
    (useReapitGet as jest.Mock).mockImplementationOnce(() => [{ customDomain: 'https://custom-domain.reapit.cloud', cloudfrontUrl: 'dfgdfgdfg.cloudfront.com', certificate: {
    ...
    expect(render(<DnsConfiguration pipelineId='pipelineId' connectSession={{
