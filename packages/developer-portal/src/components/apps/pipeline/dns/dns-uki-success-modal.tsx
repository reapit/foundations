...
export const DnsUKISuccessModal: FC<{ modalIsOpen: boolean; onModalClose: () => void }> = ({
  ...
  return (
    <Modal isOpen={modalIsOpen} onModalClose={onModalClose}>
      ...
      <BodyText>
        We have successfully created the custom domain certificate. As you are using a <code>reapit.cloud</code> domain,
        we have automatically provided the details to verify/register the certificate to the DevOps team. Once they have
