...
import { NodeData, ReducedComp, SerializedNode } from './interfaces/nodes'
type Resolver = Record<string, string | React.ElementType>
...
export const serializeNode = (data: Omit<NodeData, 'event'>, resolver: Resolver): SerializedNode => {
  const { type, props, isCanvas, ...nodeData } = data
