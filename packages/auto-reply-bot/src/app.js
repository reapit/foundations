const newIssueAddedConditions = [
  ...
  },
  {
    ...
    comment: "Thank you for raising a feature request. Feature requests will be prioritised in accordance with our roadmap, customer and developer priorities. \r\n" +
...
const labelAddedConditions = [
  ...
  {
    labels: ['too-big'],
    comment: "This issue has been reviewed and is too big to be handled in a single issue and requires the need to be broken down by our development team. We will add the associated/dependent issues to this ticket when available. \r\n" +
  ...
  },
  {
    ...
    comment: "The nature of this request requires product direction and therefore we have moved this issue into our ‘Not Ready’ column whilst we obtain the information/direction required. \r\n" +
    "This issue will be updated when a produt decision has been made. \r\n" +
    "For more information on our processes, [please click here](https://foundations-documentation.reapit.cloud/dev-requests)",
  },
  {
    labels: ['investigate'],
    comment: "We need to research or gather more information relating to this request. We have moved this issue into our ‘Not Ready’ column whilst we obtain the information required. \r\n" +
    "For more information on our processes, [please click here](https://foundations-documentation.reapit.cloud/dev-requests)",
  },
  {
...
const movedColumnResponses = {
  ['Near Term']: "This issue has been updated and moved to our ‘Near Term’ column. We have assessed the effort required and outlined a technical specification - please take the time to review this detail. When we're ready to schedule the issue, it will be assigned to the relevant board where you can continue to track its progress to completion. \r\n" +
    "For more information on our processes, [please click here](https://foundations-documentation.reapit.cloud/dev-requests)",
  ['Mid Term']: "This issue has been updated and moved to our ‘Mid Term’ column. We will assess the effort required and may outline a technical specification. When we're ready to schedule the issue, it will be moved to the ‘Near Term’ column. \r\n" +
    "For more information on our processes, [please click here](https://foundations-documentation.reapit.cloud/dev-requests)",
  ['Long Term']: "Whilst the nature of this request has been accepted, we are unable to commit to a specified sprint and therefore have assigned this issue to the ‘Long Term’ column. We will regularly review any issues and where development capacity is available, or work is aligned with our Roadmap, the issue will be updated. \r\n" +
    "For more information on our processes, [please click here](https://foundations-documentation.reapit.cloud/dev-requests)",
}
...
export default (app) => {
  app.on('issues.opened', async (event) => {
    ...
    for (const [, condition] of newIssueAddedConditions.entries()) {
      console.log('condition', condition.labels, condition.labels.every(label => issueLabels.includes(label.toLowerCase())))
  ...
  app.on('issue_comment.created', async (event) => {
    ...
    if (event.payload.issue.state === 'closed') {
      ...
      return Promise.all([
        event.octokit.issues.createComment(event.issue({ body: "It looks like you have commented on a closed issue. If your comment relates to a bug or feature request, please open a new issue, and include this issue number/url for reference. \r\n" +
        "For more information on our processes,  [please click here](https://foundations-documentation.reapit.cloud/dev-requests)" })),
      ])
    }
  })
