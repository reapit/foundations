...
export const queryGetCompanies = resolverHandler<GetCompaniesArgs, QueryGetCompaniesReturn>((_: any, args: GetCompaniesArgs, context: ServerContext): QueryGetCompaniesReturn => {
  const traceId = context.traceId
