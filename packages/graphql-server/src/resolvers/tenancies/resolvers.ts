...
export const queryGetTenancies = resolverHandler<GetTenanciesArgs, QueryGetTenanciesReturn>((_: any, args: GetTenanciesArgs, context: ServerContext): QueryGetTenanciesReturn => {
  const traceId = context.traceId
...
export const queryGetTenancyRelationships = resolverHandler<GetTenancyRelationshipsArgs, QueryGetTenancyRelationshipsReturn>((
  _: any,
