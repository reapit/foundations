...
export const queryGetLandlords = resolverHandler<GetLandlordsArgs, QueryGetLandlordsReturn>((_: any, args: GetLandlordsArgs, context: ServerContext): QueryGetLandlordsReturn => {
  const traceId = context.traceId
  logger.info('queryGetLandlords', { traceId, args })
  return landlordServices.getLandlords(args, context)
})

export const queryGetLandlordRelationshipById = resolverHandler<GetLandlordRelationshipByIdArgs, QueryGetLandlordRelationshipByIdReturn>((
  _: any,
...
export const queryGetLandlordRelationships = resolverHandler<GetLandlordRelationshipsArgs, QueryGetLandlordRelationshipsReturn>((
  _: any,
...
export const mutationCreateLandlordRelationship = resolverHandler<CreateLandlordRelationshipArgs, MutationCreateLandlordRelationshipReturn>((
  _: any,
...
export const mutationDeleteLandlordRelationship = resolverHandler<DeleteLandlordRelationshipArgs, MutationDeleteLandlordRelationshipReturn>((
  _: any,
