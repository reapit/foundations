...
describe('createPaymentReceiptInternal', () => {
  ...
  headers.forEach(header => {
    it(`should validate ${header} header is present`, async () => {
      ...
      await createPaymentReceiptInternal(mockReq as AppRequest, mockRes, mockNext, baseMockConfig)
  ...
  config.forEach(configItem => {
    it(`should validate ${configItem} config item is present`, async () => {
      ...
      await createPaymentReceiptInternal(mockReq as AppRequest, mockRes, mockNext, mockConfig)
