...
import { LoginSession, RefreshParams, removeSession, getSession, redirectToLogout } from '@reapit/cognito-auth'
...
const useAuth = (): AuthContext => {
  ...
  const getLoginSession = async (refreshParams: RefreshParams | null) => {
    ...
    const newSession = await getSession(loginSession, refreshParams, COOKIE_SESSION_KEY)
