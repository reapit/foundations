...
The Grid leverages CSS Grid to provide a responsive layout for your applications. The main grid is 8 columns width in Mobile and in tablet and above it is 12 columns. The breakpoints are explained by the variables below;
...
<RenderHtmlMarkup component="V3/Grid" story={['Basic Example']} label="Grid Rendered HTML markup" />
...
<RenderHtmlMarkup component="V3/Grid" story={['Custom Example']} label="Custom Grid Rendered HTML markup" />
...
<RenderHtmlMarkup component="V3/Grid" story={['React Example - Responsive Customisation']} label="Custom Grid Rendered HTML markup" />