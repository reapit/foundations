...
export interface CardProps extends HTMLAttributes<HTMLDivElement> {
  isMainCard?: boolean // Should we render an Image card as the main card?
  ...
  isListCard?: boolean // Should we render a bottom list section. If supplied without isMainCard, will just render a list
