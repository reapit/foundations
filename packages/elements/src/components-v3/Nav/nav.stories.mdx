...
import { elNavItemActive, elNavItemHideDesktop, elNavItemExpanded, elNavItemIcon } from './__styles__'
...
<Canvas>
  <Story name="Coming soon... React Shorthand">
    <div>
      Clearly the above example is complex to keep in sync - we will soon be offering a simplified React Shorthand Component that does the heavy lifting of building a nav for you.
    </div>
  </Story>
</Canvas>
