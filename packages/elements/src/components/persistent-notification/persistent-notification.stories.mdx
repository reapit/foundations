...
<Canvas>
  ...
  <Story name="Intent: secondary (default)">
    <PersistentNotification isExpanded={true} intent="secondary">
      Here's a notification with a secondary intent.
    </PersistentNotification>
  </Story>
  <Story name="Intent: critical">
    <PersistentNotification isExpanded={true} intent="critical">
...
<Canvas>
  ...
  <Story name="Inline notifcation, intent: secondary (default)">
    <PersistentNotification isExpanded={true} intent="secondary" isInline isFullWidth>
      Here's an inline full width notification with a secondary intent.
    </PersistentNotification>
  </Story>
  <Story name="Inline notifcation, intent: critical">
    <PersistentNotification isExpanded={true} intent="critical" isInline isFullWidth>
