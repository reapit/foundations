...
<RenderHtmlMarkup component="Table" story="Rendering children" />
...
<RenderHtmlMarkup component="Table" story="Setting the number of cols" />
...
<Canvas>
  <Story name="Table Cell - Default usage">
    <TableCell>
      <p>£556.21</p>
    </TableCell>
  </Story>
...
<RenderHtmlMarkup component="Table" story="Table Cell - Default usage" />
...
<Canvas>
  <Story name="Table Cell With an icon">
...
<RenderHtmlMarkup component="Table" story="Table Cell With an icon" />
...
<Canvas>
  <Story name="Table Cell With dark text">
    <TableCell darkText>
      <p>£556.21</p>
    </TableCell>
  </Story>
...
<RenderHtmlMarkup component="Table" story="Table Cell With dark text" />
...
<Canvas>
  <Story name="Table Cell - Narrow mode: with a label">
...
<RenderHtmlMarkup component="Table" story="Table Cell - Narrow mode: with a label" />
...
<Canvas>
  <Story name="Table Cell - Narrow mode: full width">
...
<RenderHtmlMarkup component="Table" story="Table Cell - Narrow mode: full width" />
...
<Canvas>
  <Story name="Table Cell - Narrow order">
...
You can also use the classes `el-table-cell-narrow-order-1` through to `el-table-cell-narrow-order-12`.

<RenderHtmlMarkup component="Table" story="Table Cell - Narrow order" />

## Molecule - TableRow

Props available for the React version of the component;

<ArgsTable for={TableRow} />

`TableRow` only renders children. Any other props given are applied to the underlying `div` element.

<Canvas>
  <Story name="Table Row">
    <TableRow>
...
<RenderHtmlMarkup component="Table" story="Table Row" />
...
<RenderHtmlMarkup component="Table" story="Table Headers Row" />
...
<RenderHtmlMarkup component="Table" story="Table Header" />
...
<ArgsTable component={TableExpandableRowTriggerCell} />

<Canvas>
  <Story name="Table Expandable Row Trigger Cell">
    <TableExpandableRowTriggerCell />
  </Story>
</Canvas>

<RenderHtmlMarkup component="Table" story="Table Expandable Row Trigger Cell" />

## TableExpandableRowTriggerCell isOpen

<Canvas>
  <Story name="Table Expandable Row Trigger Cell is open">
    <TableExpandableRowTriggerCell isOpen />
  </Story>
</Canvas>

<RenderHtmlMarkup component="Table" story="Table Expandable Row Trigger Cell is open" />
...
<Canvas>
  <Story name="Table Expandable Row Trigger Cell narrow full width">
    <TableExpandableRowTriggerCell narrowIsFullWidth />
  </Story>
</Canvas>

<RenderHtmlMarkup component="Table" story="Table Expandable Row Trigger Cell narrow full width" />
...
<ArgsTable component={TableExpandableRow} />

<Canvas>
  <Story name="Table Expandable Row">
    <TableExpandableRow>
...
<RenderHtmlMarkup component="Table" story="Table Expandable Row" />

## TableExpandableRow isOpen

<Canvas>
  <Story name="Table Expandable Row - is open">
    <TableExpandableRow isOpen>
      <p>Content that won't be seen until the expandable row is open</p>
    </TableExpandableRow>
  </Story>
...
<RenderHtmlMarkup component="Table" story="Table Expandable Row - is open" />
...
<Canvas>
  <Story name="Table Expandable Row - expandable-content-size">
    <Table
    ...
    >
      <TableRowContainer isOpen>
        ...
        <TableExpandableRow isOpen>
          <p>
            This form will send an email request for payment to your customer with an embedded link to our card
...
<RenderHtmlMarkup component="Table" story="Table Expandable Row - expandable-content-size" />
...
<ArgsTable component={TableRowContainer} />

<Canvas>
  <Story name="Table Row Container">
  ...
  <Story name="Column Table Cell narrowIsFullWidth">
    <Table data-num-columns-excl-expandable-row-trigger-col="6">
      ...
      <TableRow>
        ...
        <TableCell>cell 2</TableCell>
        <TableCell>cell 3</TableCell>
        <TableCell narrowIsFullWidth>cell 4</TableCell>
        <TableCell>cell 5</TableCell>
        <TableCell>cell 6</TableCell>
      </TableRow>
    </Table>
...
You can also use the class `el-table-narrow-cell-is-full-width`.
