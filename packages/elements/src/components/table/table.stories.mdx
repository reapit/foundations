        ...
        <TableRow>
          ...
          <TableCell narrowLabel="Type">
            <FlexContainer isFlexColumn>
              <TextSM className={elTextEllipsis}>Some description</TextSM>
              <TextXS className={elTextEllipsis} hasGreyText>
    ...
    <Table data-num-columns-excl-action-col="7" data-has-call-to-action>
      ...
      <TableRowContainer>
        <TableRow>
          ...
          <TableCtaTriggerCell icon="downloadSolidSystem" />
        </TableRow>
      </TableRowContainer>
    </Table>
  </Story>
