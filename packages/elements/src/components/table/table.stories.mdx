...
<ArgsTable component={TableRow} story="TableRow" />
...
<ArgsTable of={TableExpandableRow} story="TableExpandableRow" />
...
<ArgsTable component={TableRowContainer} story="TableRowContainer" />

<Canvas>
  <Story name="TableRowContainer">
