...
You can adjust the size of the expandable content section using the `data-expandable-content-size` data attribute on the table. The fixed heights are required for the drop down animation.
...
<Canvas>
  <Story name="TableExpandableRow - expandable-content-size">
    <Table data-num-columns-excl-expandable-row-trigger-col="7" data-has-expandable-action data-expandable-content-size="large">
      <TableRowContainer isOpen>
        <TableRow>
          ...
          <TableCell narrowIsFullWidth><StatusIndicator intent="critical" /> Pending</TableCell>
          <TableExpandableRowTriggerCell isOpen />
        </TableRow>
        <TableExpandableRow isOpen>
    ...
    <Table data-num-columns-excl-expandable-row-trigger-col="7" data-has-expandable-action>
      <TableRowContainer isOpen>
        <TableRow>
          ...
          <TableCell narrowLabel="Request Date">19 Apr 2021</TableCell>
          <TableCell darkText>£50.00</TableCell>
          <TableCell narrowIsFullWidth><StatusIndicator intent="danger" /> Pending</TableCell>
          <TableExpandableRowTriggerCell isOpen />
        </TableRow>
        <TableExpandableRow isOpen>
          <p>Content that won't be seen until the expandable row is open</p>
  ...
  <Story name="Column Table Expandable action">
    <Table data-num-columns-excl-expandable-row-trigger-col="4" data-has-expandable-action>
      <TableHeadersRow>
        ...
        <TableHeader>3</TableHeader>
        <TableHeader>4</TableHeader>
        <TableHeader><Icon icon="home"/></TableHeader>
      </TableHeadersRow>
      <TableRow>
        <TableCell>
          cell 1
