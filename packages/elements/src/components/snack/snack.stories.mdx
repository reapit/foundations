...
<Canvas>
  ...
  <Story name="Intent: Neutral">
    <Snack intent="neutral" icon="infoSolidSystem">
      Neutral message goes here
    </Snack>
  </Story>
  <Story name="Intent: Success">
    <Snack intent="success" icon="checkSolidSystem">
      Success message goes here
    </Snack>
  </Story>
  <Story name="Intent: Pending">
    <Snack intent="pending" icon="circleSolidSystem">
      Pending message goes here
    </Snack>
  </Story>
  <Story name="Intent: Warning">
    <Snack intent="warning" icon="warningSolidSystem">
  ...
  <Story name="Intent: Default">
    <Snack intent="default" icon="infoSolidSystem">
