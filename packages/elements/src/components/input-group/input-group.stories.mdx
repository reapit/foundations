...
<RenderHtmlMarkup component="InputGroup" story="With AfterInputText only" />
...
<Canvas>
  <Story name="React shorthand - all props">
    <InputGroup icon="asteriskSystem" label="Email address" afterInputText="Required" intent="danger" type="text" />
  </Story>
</Canvas>
...
<Canvas>
  <Story name="Type: checkbox">
    <InputGroup type="checkbox" icon="phoneSystem" label="Status" afterInputText="Listed" />
  </Story>
  <Story name="Type: checkbox - with intent">
    <InputGroup type="checkbox" icon="infoSystem" intent="danger" label="Status" afterInputText="Listed" />
  </Story>
