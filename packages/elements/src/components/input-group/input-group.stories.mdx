...
<Canvas>
  <Story name="React shorthand">
    <InputGroup icon="property" label="Please enter an address" type="text" />
  </Story>
</Canvas>
...
<Canvas>
  <Story name="React shorthand - custom ID">
    <InputGroup id="my-id" icon="property" label="Please enter an address" type="text" />
  </Story>
</Canvas>
...
<Canvas>
  <Story name="Input checkbox">
    <InputGroup type="checkbox" icon="phone" label="Status" InputAddOn="Listed" />
  </Story>
  <Story name="Input checkbox - with intent">
    <InputGroup type="checkbox" icon="info" intent="danger" label="Status" InputAddOn="Listed" />
  </Story>
...
<Canvas>
  ...
  <Story name="Input radio - with intent">
    <Label className="el-mb2 el-flex">Preferred contact</Label>
    <InputGroup className="el-mb2" type="radio" name="phone" label="Mobile phone" intent="danger" />
    <InputGroup className="el-mb2" type="radio" name="phone" label="Home phone" intent="danger" />
    <InputGroup className="el-mb2" type="radio" name="phone" label="Email" intent="danger" />
  </Story>
</Canvas>
