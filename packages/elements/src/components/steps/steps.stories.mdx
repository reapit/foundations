...
Used to indicate position in a process - for example a Wizard.
...
<RenderHtmlMarkup component="Steps" story="Basic Usage" />
          ...
          content: (
            <>
              ...
              <ButtonGroup alignment="right">
                <Button intent="critical" size={2} chevronRight type="submit" onClick={() => setSelectedStep('2')}>
                  Complete Step 1
                </Button>
              </ButtonGroup>
            </>
        ...
        },
        {
          ...
          content: (
            <>
              ...
              <ButtonGroup alignment="right">
                <Button intent="critical" size={2} chevronRight type="submit" onClick={() => setSelectedStep('3')}>
                  Complete Step 2
                </Button>
              </ButtonGroup>
            </>
        ...
        },
        {
          ...
          content: (
            <>
              ...
              <ButtonGroup alignment="right">
                <Button intent="critical" size={2} chevronRight type="submit" onClick={() => setSelectedStep('4')}>
                  Complete Step 3
                </Button>
              </ButtonGroup>
            </>
        ...
        },
        {
          ...
          content: (
            <>
              ...
              <ButtonGroup alignment="right">
                <Button intent="critical" size={2} chevronRight type="submit" onClick={() => setSelectedStep('5')}>
                  Complete Step 4
                </Button>
              </ButtonGroup>
            </>
