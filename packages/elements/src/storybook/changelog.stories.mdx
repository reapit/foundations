...
There are multiple significant changes in this release however, for the majority of users upgrading from v3.x.x, these should be visual and cosmetic. No functions, CSS classes or React props have been removed however, many have been deprecated. In all cases where there has been a deprecation, React there are console warnings and 
