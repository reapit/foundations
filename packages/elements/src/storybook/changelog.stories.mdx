...
- Renames `PersisantNotification` to `PersisentNotification` to correct spelling. No breaking change, old component is still exported for now, deprecation notice added.
