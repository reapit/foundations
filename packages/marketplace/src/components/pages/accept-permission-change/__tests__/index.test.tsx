...
import { appDetailDataStub as mockAppDetail } from '../../../../sagas/__stubs__/app-detail'
...
jest.mock('@reapit/utils-react', () => ({
  useReapitGet: jest.fn(() => [mockAppDetail]),
...
describe('handleApprove', () => {
  it('should approve a permission change', async () => {
    ...
    expect(history.push).toHaveBeenCalledWith(Routes.INSTALLED_APPS)
  })
})
