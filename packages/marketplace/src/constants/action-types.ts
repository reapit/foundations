...
const ActionTypes = {
  ...
  CLIENT_WEB_COMPONENT_CONFIG_OPEN: 'CLIENT_WEB_COMPONENT_CONFIG_OPEN',
  CLIENT_WEB_COMPONENT_CONFIG_CLOSE: 'CLIENT_WEB_COMPONENT_CONFIG_CLOSE',
  ...
  CLIENT_PUT_WEB_COMPONENT_CONFIG: 'CLIENT_PUT_WEB_COMPONENT_CONFIG',
  ...
  // submit app step
  DEVELOPER_SUBMIT_APP_WIZZARD_CHANGE_STEP: 'DEVELOPER_SUBMIT_APP_CHANGE_STEP',
