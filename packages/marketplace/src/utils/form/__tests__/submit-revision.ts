...
describe('submitRevisionValidation', () => {
  ...
  it('validate maximum character length', () => {
    const gt150CharString = `Pellentesque quis scelerisque ex. Fusce pharetra sapien eu odio hendrerit bibendum. 
      Nullam pellentesque vel tellus eu dictum. Cras eu sapien vitae elit vestibulum porta. Phasellus sagittis est 
      eget vestibulum pellentesque. Integer ut finibus turpis. Vestibulum sodales placerat mauris, nec bibendum justo 
      scelerisque in. Suspendisse sodales maximus arcu, nec ultricies ex commodo et.`
    const input: CreateAppRevisionModel = {
      name: 'john doe',
      telephone: '999999999',
  ...
  it('return empty object it everything is valid', () => {
    const input: CreateAppRevisionModel = {
      ...
      description: `Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam scelerisque blandit est, et laoreet 
        sapien congue vitae. Nulla lacus nulla, interdum quis bibendum in, consequat gravida quam.`,
