export const enum TrackingEvent {
  ...
  ClickCollectionsTile = 'Click Collections Tile, Apply Filters',
  ClickClearFilters = 'Click Clear Filters Button',
  SearchApps = 'Search Term Change',
  AddFilterCategory = 'Add Filter Category',
  RemoveFilterCategory = 'Remove Filter Category',
  ClickMobileControls = 'Click Mobile Controls',
  ClickSeeAllFilter = 'Click See All Collection, Apply Filters',
