import appSumarryReducer, { defaultState } from '../app-summary'
...
describe('appsumar reducer', () => {
  it('should return default state if action not matched', () => {
    const newState = appSumarryReducer(undefined, { type: 'UNKNOWN' as ActionType, data: undefined })
    expect(newState).toEqual(defaultState)
  })

  it('should set loading to true when CLIENT_FETCH_APP_SUMMARY action is called', () => {
    const newState = appSumarryReducer(undefined, {
