...
var require_sign = __commonJS({
  "../../node_modules/jsonwebtoken/sign.js"(exports2, module2) {
    ...
    var sign_options_schema = {
      expiresIn: {
        isValid: /* @__PURE__ */ __name(function(value) {
...
var JwtBaseError = class extends Error {
  static {
    __name(this, "JwtBaseError");
  }
};
var FailedAssertionError = class extends JwtBaseError {
  static {
    __name(this, "FailedAssertionError");
  }
...
var NonRetryableFetchError = class extends FetchError {
  static {
    __name(this, "NonRetryableFetchError");
  }
};
...
var nodeWebCompat = {
  fetchJson,
  transformJwkToKeyObjectSync: /* @__PURE__ */ __name((jwk) => (0, import_crypto.createPublicKey)({
    key: constructPublicKeyInDerFormat(Buffer.from(jwk.n, "base64"), Buffer.from(jwk.e, "base64")),
    format: "der",
    type: "spki"
  }), "transformJwkToKeyObjectSync"),
  transformJwkToKeyObjectAsync: /* @__PURE__ */ __name(async (jwk) => (0, import_crypto.createPublicKey)({
    key: constructPublicKeyInDerFormat(Buffer.from(jwk.n, "base64"), Buffer.from(jwk.e, "base64")),
    format: "der",
    type: "spki"
  }), "transformJwkToKeyObjectAsync"),
  parseB64UrlString: /* @__PURE__ */ __name((b64) => Buffer.from(b64, "base64").toString("utf8"), "parseB64UrlString"),
  verifySignatureSync: /* @__PURE__ */ __name(({ alg, keyObject, jwsSigningInput, signature }) => (
  ...
  verifySignatureAsync: /* @__PURE__ */ __name(async ({ alg, keyObject, jwsSigningInput, signature }) => (
    // eslint-disable-next-line security/detect-object-injection
    (0, import_crypto.createVerify)(JwtSignatureAlgorithms[alg]).update(jwsSigningInput).verify(keyObject, signature, "base64")
  ...
  setTimeoutUnref: /* @__PURE__ */ __name((...args) => setTimeout(...args).unref(), "setTimeoutUnref")
};
...
var JwtRsaVerifierBase = class {
  static {
    __name(this, "JwtRsaVerifierBase");
  }
...
var CognitoJwtVerifier = class _CognitoJwtVerifier extends JwtRsaVerifierBase {
  static {
    __name(this, "CognitoJwtVerifier");
  }
