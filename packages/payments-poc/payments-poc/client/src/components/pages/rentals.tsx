...
const stripePromise = getStripePublicKey().then((key) =>
  loadStripe(key as string)
)
...
const Rentals: React.FC = () => {
  ...
  const [payment, setPayment] = useState(
    null as StripePaymentIntentRequest | null
  )
    ...
    <>
      ...
      {isOverdue && (
        <Helper variant="warning">
          Rent is 5 days overdue for this property.
        </Helper>
      )}
      {!isOverdue && (
        <Helper variant="info">Rent now up to date for this property.</Helper>
      )}
