export const webAppsDev = [
  ...
  { appName: 'Geo Diary', url: 'https://geo-diary-app.dev.paas.reapit.cloud' },
  { appName: 'Marketplace', url: 'https://marketplace.dev.paas.reapit.cloud' },
  { appName: 'Marketplace Management', url: 'https://marketplace-management.dev.paas.reapit.cloud' },
  { appName: 'Payments Client', url: 'https://payments.dev.paas.reapit.cloud' },
  { appName: 'Reapit Connect Welcome', url: 'https://reapit-connect.dev.paas.reapit.cloud' },
]
...
export const nodeServicesProd = [
  { appName: 'Mailer Service', url: 'https://dtdozuop83.execute-api.eu-west-2.amazonaws.com/prod' },
  { appName: 'Payment Service', url: 'https://yzf9lus8ak.execute-api.eu-west-2.amazonaws.com/prod' },
]
