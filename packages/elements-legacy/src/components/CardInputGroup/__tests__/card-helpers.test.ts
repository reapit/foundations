...
const mockWhitelistCard = '0000000000000000'
...
describe('formatCardNumber', () => {
  it('should correctly format an amex', () => {
    ...
    expect(formatCardNumber(raw, mockInput)).toEqual(mockAmexOne)
  })

  it('should correctly format a non amex', () => {
    const raw = '4000000000000000'

    expect(formatCardNumber(raw, mockInput)).toEqual(mockVisa)
  })
})
...
describe('formatCardExpires', () => {
  it('should correctly format a card expiry', () => {
    ...
    expect(formatCardExpires(raw, mockInput)).toEqual(expected)
  })
})
