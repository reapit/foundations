...
export class cliRefactor1637591977282 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query("ALTER TABLE `pipelines` ADD COLUMN `type` varchar(36) NOT NULL DEFAULT 'BUILD'");
        await queryRunner.query("ALTER TABLE `pipelines` ADD COLUMN `buildVersion` varchar(10)");
        await queryRunner.query("ALTER TABLE `pipelines` ADD COLUMN `currentlyDeployed` tinyint(1) NOT NULL DEFAULT 0");
    }
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query("ALTER TABLE `pipelines` DROP COLUMN `currentlyDeployed`");
        await queryRunner.query("ALTER TABLE `pipelines` DROP COLUMN `buildVersion`");
