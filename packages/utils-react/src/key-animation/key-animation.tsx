...
export const KeyAnimation: FC<{ step: 1 | 2 | 3 }> = ({ step }) => {
  return (
    <>
      ...
      >
        <path d="M0 0H338L79 900H0V0Z" fill="var(--info-graphic-accent-color-light)" />
        <path d="M0 682V437.5L236.5 900H0V682Z" fill="var(--info-graphic-accent-color-med)" />
        <path d="M0 0H338L296.5 147.5L0 51.5V0Z" fill="var(--info-graphic-accent-color-darkest)" />
        <path
        ...
        />
        <path
          d="M90.5 476.5V395.5L58 408L57.5 462L63 469L90.5 476.5Z"
          fill="var(--info-graphic-accent-color-darkest)"
        />
        <path
        ...
        />
        <path
          className={cx(triangle2)}
          d="M169 691.343L191.514 643L218 749L169 691.343Z"
          fill="var(--info-graphic-accent-color-med)"
        />
        <path
          className={cx(triangle3)}
          d="M246 575H217L226.762 609L246 575Z"
          fill="var(--info-graphic-accent-color-darkest)"
        />
        <path
          className={stars}
