...
import { createStripePaymentIntent, StripePaymentIntentRequest } from '../../payments-api/stripe'
...
export default function CheckoutForm({
  ...
  const renderSuccess = () => {
    ...
    return (
      <>
        <Alert type="success" message={`Payment of ${currency} ${amount} received for ${property.id}`} />
