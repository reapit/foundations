...
export const createStripePaymentIntent = async (options: StripePaymentIntentRequest) => {
  try {
    const paymentIntent: StripePaymentIntentResponse | undefined = await fetcher({
