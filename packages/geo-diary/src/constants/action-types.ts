...
const ActionTypes = {
  ...
  AUTH_SET_REFRESH_SESSION_LOGIN_TYPE: 'AUTH_SET_REFRESH_SESSION_LOGIN_TYPE',
  ...
  APPOINTMENTS_RECEIVE_TODAY_DATA: 'APPOINTMENTS_RECEIVE_TODAY_DATA',
  APPOINTMENTS_RECEIVE_TOMORROW_DATA: 'APPOINTMENTS_RECEIVE_TOMORROW_DATA',
  APPOINTMENTS_RECEIVE_WEEK_DATA: 'APPOINTMENTS_RECEIVE_WEEK_DATA',
  ...
  SHOW_HIDE_CONFIRM_MODAL: 'SHOW_HIDE_CONFIRM_MODAL',
  SHOW_CONFIRM_MODAL_SUBMITTING: 'SHOW_CONFIRM_MODAL_SUBMITTING',
