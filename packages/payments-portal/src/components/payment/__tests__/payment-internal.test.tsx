...
// import { handleSetPaymentWithProperty, PaymentInternalPage } from '..'
...
//     const curried = handleSetPaymentWithProperty(setPaymentWithProperty,
// mockPaymentModel, mockPropertyModel, clientId)
