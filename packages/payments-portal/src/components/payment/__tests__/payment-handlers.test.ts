...
// import { generateEmailPaymentReceipt, updatePaymentStatus } from '../../../services/payment'
...
//   generateEmailPaymentReceipt: jest.fn(() => true),
// }))
...
//     expect(generateEmailPaymentReceipt).toHaveBeenCalledWith(stubEmailBody, stubUpdateStatusParams, errorSnack)
...
//   const onSubmit = onHandleSubmit(merchantKey, mockPaymentWithPropertyModel, pa
// ymentId, jest.fn(), jest.fn(), session)
