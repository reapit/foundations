...
var app = (function () {
	...
	*/
	...
	var file = "src/search-widget/components/counter.svelte";
	...
	function create_fragment(ctx) {
	  ...
	  var block = {
	    c: function create() {
	      ...
	      button1.textContent = "-";
	      attr_dev(div0, "data-testid", "counter-value");
	      add_location(div0, file, 6, 2, 111);
	      add_location(button0, file, 7, 2, 160);
	      add_location(button1, file, 8, 2, 214);
	...
	function instance($$self, $$props, $$invalidate) {
	  ...
	  var writable_props = ["value", "step"];
	  Object.keys($$props).forEach(function (key) {
	    if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console.warn("<Counter> was created with unknown prop '".concat(key, "'"));
	  });
	  ...
	  var click_handler = function click_handler() {
	    return $$invalidate(0, value += step);
	  };
	...
	function (_SvelteComponentDev) {
	  _inherits(Counter, _SvelteComponentDev);
	  ...
	  function Counter(options) {
	    ...
	    _this = _possibleConstructorReturn(this, _getPrototypeOf(Counter).call(this, options));
	...
	var file$1 = "src/search-widget/components/search-widget.svelte"; // (25:2) <Counter value={1}>
	...
	function create_fragment$1(ctx) {
	  ...
	  /*$count*/
	  ctx[1] !== void 0) {
	    counter2_props.value =
	    /*$count*/
	    ctx[1];
	  }

	  var counter2 = new Counter({
	    props: counter2_props,
	    $$inline: true
	  });
	  binding_callbacks.push(function () {
	    return bind$1(counter2, "value", counter2_value_binding);
	  });
	  ...
	  /*$myStore*/
	  ctx[2] !== void 0) {
	    counter3_props.value =
	    /*$myStore*/
	    ctx[2];
	  }

	  var counter3 = new Counter({
	    props: counter3_props,
	    $$inline: true
	  });
	  binding_callbacks.push(function () {
	    return bind$1(counter3, "value", counter3_value_binding);
	  });
	  var block = {
	    c: function create() {
	      h1 = element("h1");
	      ...
	      add_location(h1, file$1, 21, 0, 453);
	      add_location(p, file$1, 22, 0, 476);
	    },
	    l: function claim(nodes) {
	      throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
	    },
	    ...
	    p: function update(ctx, _ref) {
	      ...
	      var counter3_changes = {};

	      if (dirty &
	      /*$$scope*/
	      128) {
	        counter3_changes.$$scope = {
	          dirty: dirty,
	          ctx: ctx
	        };
	      }
	...
	function instance$1($$self, $$props, $$invalidate) {
	  ...
	  component_subscribe($$self, myStore, function ($$value) {
	    return $$invalidate(2, $myStore = $$value);
	  });
	  var count = writable(100);
	  validate_store(count, "count");
	  component_subscribe($$self, count, function (value) {
	    return $$invalidate(1, $count = value);
	  });
	  ...
	  Object.keys($$props).forEach(function (key) {
	    if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console_1.warn("<Search_widget> was created with unknown prop '".concat(key, "'"));
	  });
	  ...
	  return [name, $count, $myStore, count, unsubscribe, counter2_value_binding, counter3_value_binding];
	}

	var Search_widget =
	/*#__PURE__*/
	function (_SvelteComponentDev) {
	  _inherits(Search_widget, _SvelteComponentDev);

	  function Search_widget(options) {
	    var _this;

	    _classCallCheck(this, Search_widget);

	    _this = _possibleConstructorReturn(this, _getPrototypeOf(Search_widget).call(this, options));
	    init(_assertThisInitialized(_this), options, instance$1, create_fragment$1, safe_not_equal, {
	      name: 0
	    });
	    dispatch_dev("SvelteRegisterComponent", {
	      component: _assertThisInitialized(_this),
	      tagName: "Search_widget",
	      options: options,
	      id: create_fragment$1.name
	    });
	    var ctx = _this.$$.ctx;
	    ...
	    ctx[0] === undefined && !("name" in props)) {
	      console_1.warn("<Search_widget> was created without expected prop 'name'");
	    }

	    return _this;
	  }

	  _createClass(Search_widget, [{
	    key: "name",
	    get: function get() {
	      throw new Error("<Search_widget>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
	    },
	    set: function set(value) {
	      throw new Error("<Search_widget>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
	    }
	  }]);
	...
	const searchWidget = new Search_widget({
