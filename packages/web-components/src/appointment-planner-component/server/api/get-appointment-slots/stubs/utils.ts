...
export const assignNegotiatorIdToAppointmentSlotOfDatesOutput: AppoinmentSlotsOfDate[] = [
  {
...
export const assignNegotiatorIdToAppointmentSlotOfDatesParams: AssignNegotiatorIdToAppointmentSlotOfDatesParams = {
  appointments: [
    {
      id: 'RPT2000076',
  ...
  appointmentSlotsOfDates: [
    {
      date: '2021-01-31T20:00:00.000Z',
      slots: [
        { dateTimeStart: '2021-01-31T08:00:00.000Z', dateTimeEnd: '2021-01-31T12:00:00.000Z' },
        { dateTimeStart: '2021-01-31T16:00:00.000Z', dateTimeEnd: '2021-01-31T20:00:00.000Z' },
      ],
    },
    {
      date: '2021-02-01T20:00:00.000Z',
      slots: [
        { dateTimeStart: '2021-02-01T08:00:00.000Z', dateTimeEnd: '2021-02-01T12:00:00.000Z' },
        { dateTimeStart: '2021-02-01T16:00:00.000Z', dateTimeEnd: '2021-02-01T20:00:00.000Z' },
      ],
    },
  ],
...
export const findAvailableNegotiatorIdParams: Record<
  string,
  { input: FindAvailableNegotiatorIdParams; output: string | null }
> = {
  caseFirstFreeSecondBusy: {
    ...
    input: {
      ...
      dateTimeEnd: new Date('2021-02-01T12:00:00.000Z'),
      dateTimeStart: new Date('2021-02-01T08:00:00.000Z'),
    },
  },
