...
//   (handleOnClose: () => void, onRefetchData: () => void, orgId: string) => async (params: Creat
// eOfficeGroupModel) => {
...
//   const [selectedOffice, setSelectedOffice] = useState<MultiSelectOption[]>([])
...
//         <p>
//           To create a new office group, please provide a group ‘Name’ and search and select an
// Office(s). You will need
