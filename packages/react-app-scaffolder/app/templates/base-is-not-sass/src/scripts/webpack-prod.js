...
// HEAD~1: Hash appended to files in commit N will be generated by commit N - 1
const headCommitHash = execSync('git rev-parse HEAD')
const outputFileName = `[name].${headCommitHash.toString().trim()}.js`
