import { authenticatedRequestData, authenticatedReceiveData, authenticatedRequestDataFailure, authenticatedLoading, authenticatedClearData } from '../authenticated'
