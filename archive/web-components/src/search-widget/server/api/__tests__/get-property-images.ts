...
import { propertyImagesStub, propertyImagesMinimalStub } from '../__stubs__/property-images'
...
describe('property images server API', () => {
  it('should correctly call the fetcher for property images', async () => {
    ...
    expect(mapMinimalProperties).toHaveBeenCalledWith(propertyImagesStub, INCLUDED_PROPS.GET_PROPERTY_IMAGES)
